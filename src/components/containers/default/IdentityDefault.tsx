...
import LoginPage from "../../authentication/login/LoginPage.tsx";
import RegisterPage from "../../authentication/register/RegisterPage.tsx";
...
const IdentityDefault = () => {
    ...
    useEffect(() => {
        // Встановлення фокусу на кнопку логіну при завантаженні сторінки
                                ...
                                <div className="Frame20">
                                    ...
                                    <div className="Frame19">
                                        ...
                                        <div className="Frame12">
                                            ...
                                            <button onClick={() => handleButtonClick('register')} className="Frame3">
